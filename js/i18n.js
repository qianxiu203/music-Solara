(function () {
    const translations = {
        ...
        "管理音源": "Manage Sources",
        "当前音源": "Current Source",
        "点击切换音源": "Click to switch source",
        "音源": "Source",
        "关闭": "Close",
        "添加自定义音源": "Add Custom Source",
        "音源名称": "Source Name",
        "例：我的源": "e.g. My Source",
        "源 ID": "Source ID",
        "例：netease / my_api": "e.g. netease / my_api",
        "API 服务": "API Service",
        "留空=默认 GD": "Leave empty = default GD",
        "使用默认（GD Studio）": "Use default (GD Studio)",
        "添加音源": "Add Source",
        "暂无自定义音源": "No custom sources yet",
        "删除": "Delete",
        "已添加": "Added",
        "已删除": "Deleted",
        "请填写名称和源 ID": "Please fill in name and source ID",
        "该源 ID 已存在，请勿重复添加": "This source ID already exists",
        "源 ID 仅支持字母、数字、下划线和横杠": "Source ID only supports letters, numbers, underscores and hyphens",
        "探索雷达：未找到歌曲": "Explore Radar: No songs found",
        "请输入口令": "Please enter password",
        "会话已锁定，请稍后重试": "Session locked, please try again later",
        "退出失败，请手动清除 cookie": "Logout failed, please clear cookie manually"
    };
